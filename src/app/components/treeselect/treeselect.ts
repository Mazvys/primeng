...
import { OverlayOptions, OverlayService, PrimeNGConfig, PrimeTemplate, SharedModule, TreeNode } from '@mazvysp/primeng/api';
...
import { Tree, TreeModule } from '@mazvysp/primeng/tree';
